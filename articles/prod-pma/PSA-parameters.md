...
description: 이 문서에서는 Microsoft Dynamics 365 for Project Service Automation을 Microsoft Dynamics 365 Finance와 통합할 때 기본 데이터가 입력되는 방식을 구성하는 방법에 대해 설명합니다.
author: ruhercul
ms.date: 03/03/2020
ms.topic: article
ms.prod: ''
