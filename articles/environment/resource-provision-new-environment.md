...
4. 역할에 다음 엔터티에 대한 **읽기** 및 **다른 레코드에 추가** 권한이 있는지 확인합니다.
...
3. 맵을 시작합니다. 자세한 내용은 [Project Operations 이중 쓰기 맵 버전](resource-dual-write-maps.md#project-operations-dual-write-maps)을 참조하십시오
4. 모든 프로젝트 관련 맵이 실행 중 상태인지 확인합니다.
