...
2. **미리 보기 기능** 목록에서 **Project Operations**를 선택하고 **미리 보기 기능 활성화됨**을 선택하여 Project Operations를 활성화합니다.
...
1. 새로운 Dynamics 365 Finance [데모 환경](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/deployment/deploy-demo-environment) 또는 [샌드박스/프로덕션 환경](https://docs.microsoft.com/edynamics365/fin-ops-core/dev-itpro/deployment/deployenvironment-newinfrastructure)을 엽니다. 
...
| **시간 추정용 Project Operations 통합 엔터티(msdyn\_resourceassignments)** | 없음 | 없음 | 해당 없음 | 없음 | 해당 없음 |
...
5. 새로 고침이 완료된 후 맵 실행을 계속합니다.

![맵 새로 고침](./media/20RefreshMapping.png)

다음 맵을 활성화하기 전에 테이블의 맵이 **실행 중** 상태인지 확인합니다. 많은 수의 필수 구성 요소가 있는 맵을 실행하는 데 시간이 걸릴 수 있습니다.
