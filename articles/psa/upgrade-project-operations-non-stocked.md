...
description: 이 토픽에서는 Microsoft Dynamics 365 Project Service Automation에서 Dynamics 365 Project Operations로 업그레이드하는 프로세스에 대한 개요를 제공합니다.
author: ruhercul
...
Microsoft Dynamics 365 Project Service Automation에서 Dynamics 365 Project Operations로 업그레이드를 위한 3단계 중 첫 번째 단계를 발표하게 된 것을 기쁘게 생각합니다. 이 토픽은 이 흥미진진한 여정을 시작하는 고객을 위한 개요를 제공합니다. 향후 토픽에는 개발자 고려 사항 및 기능 향상에 대한 세부 정보가 포함됩니다. Project Operations로의 업그레이드를 준비하는 데 도움이 되는 지침을 제공할 뿐만 아니라 업그레이드 후 기대할 수 있는 사항도 설명합니다.

업그레이드 제공 프로그램은 세 단계로 나뉩니다.

| 업그레이드 전달 | 1단계(2022년 1월) | 2단계(2022년 4월 웨이브) | 3단계(2022년 4월 웨이브) |
|------------------|------------------------|---------------------------|---------------------------|
...
| 유효성 검사 | 1단계(2022년 1월) | 2단계(2022년 4월 웨이브) | 3단계(2022년 4월 웨이브) |
|-------------|------------------------|---------------------------|---------------------------|
...
| WBS는 Project Desktop Client의 알려진 제한 사항에 대한 유효성을 검증합니다. | | :heavy_check_mark: | :heavy_check_mark: |
...
- 대상 환경은 Project Service Automation 업데이트 릴리스 38 이상으로 업데이트해야 합니다.
...
## <a name="end-to-end-testing-in-lower-environments"></a>낮은 환경에서 엔드 투 엔드 테스트

### <a name="run-the-upgrade-in-production"></a>프로덕션에서 업그레이드 실행
...
3. 사용자 정의 솔루션을 적절하게 업그레이드하십시오. 이 시점에서 이 항목의 [사용자 지정 테스트 및 리팩토링](#testing-and-refactoring-customizations) 섹션에서 사용자 지정에 대한 변경 사항을 배포합니다.
...
| Finance 프로젝트 관리 및 회계              | 리소스/생산 주문 시나리오에 대한 Project Operations | 현재 지원되지 않음 |
