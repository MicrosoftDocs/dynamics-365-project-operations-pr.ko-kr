...
description: 이 문서는 Project Service Automation 업데이트 릴리스 15, V3에서 새로운 내용에 대한 정보를 제공합니다.
author: ruhercul
...
이 문서에는 PSA V3, 업데이트 릴리스 15의 새로운 기능과 수정 사항이 나와 있습니다. 이 버전의 빌드 번호는 V3.10.5.28이며 2020년 1월에 자체 업데이트를 통해 일반적으로 제공됩니다.
