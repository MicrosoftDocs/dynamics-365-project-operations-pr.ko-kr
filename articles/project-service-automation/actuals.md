...
## <a name="using-journals-to-record-costs"></a>분개장을 사용한 비용 기록

PSA에서는 분개장을 사용하면 비용 또는 수익을 자재, 수수료, 시간, 경비 또는 세금 처리 등급에 기록할 수 있습니다. 분개장에는 표제, 행 및**확인** 작업이 있습니다. 다음은 분개장을 사용할 수 있는 몇 가지 시나리오입니다:
