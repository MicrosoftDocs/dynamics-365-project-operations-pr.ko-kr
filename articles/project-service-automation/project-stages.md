...
---
# <a name="project-stages"></a>프로젝트 단계 

[!INCLUDE[cc-applies-to-psa-app-3.x](../includes/cc-applies-to-psa-app-3x.md)]

프로젝트 단계는 프로젝트가 진행됨에 따라 프로젝트의 상태를 반영하도록 업데이트됩니다. 기본 비즈니스 프로세스 흐름은 프로젝트의 일부 단계를 자동으로 업데이트하지만 다른 단계는 프로젝트 관리자가 수동으로 업데이트합니다. 
