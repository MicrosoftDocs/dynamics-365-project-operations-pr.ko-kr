...
- **\<EntitiesToEnableScheduling\>** Microsoft Dynamics 일정(즉, Universal Resource Scheduling)에서 예약할 수 있는 엔터티를 지정합니다.
...
- **\<PluginsToDisable\>** 은 샘플 데이터 가져오기 중에 비활성화해야 하는 매우 불연속 라인 항목 플러그인을 지정한 다음 나중에 다시 활성화합니다.
