...
description: 이 문서에서는 계약 내용에서 송장 일정 및 이정표를 생성하는 방법에 대한 정보를 제공합니다.
author: rumant
ms.date: 10/17/2020
ms.topic: article
...
ms.locfileid: "9825106"
---
# <a name="create-invoice-schedules-on-a-project-based-contract-line"></a>프로젝트 기반 계약 내용에 송장 일정 만들기
