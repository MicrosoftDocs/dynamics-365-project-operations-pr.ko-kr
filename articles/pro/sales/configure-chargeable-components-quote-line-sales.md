---
title: 프로젝트 견적 라인에 청구 가능한 구성 요소 구성
description: 이 문서에서는 프로젝트 기반 견적 라인에 청구 가능한 구성 요소 및 청구 불가능한 구성 요소 설정에 대한 정보를 제공합니다.
author: rumant
ms.date: 03/30/2021
ms.topic: article
...
ms.locfileid: "9825526"
---
# <a name="configure-chargeable-components-on-project-quote-lines"></a>프로젝트 견적 라인에 청구 가능한 구성 요소 구성
